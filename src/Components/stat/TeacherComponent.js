                            ...
                            <Table style={{borderTopWidth: 1, borderStyle: 'solid', maxWidth: 1100}}>
                                <TableHead>
                                    <TableRow style={{borderTopWidth: 3, borderStyle: 'solid'}}>
                                        ...
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Ниже среднего</TableCell>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Средний</TableCell>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Выше среднего</TableCell>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Высокий</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    <TableRow>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Заведующий</TableCell>
                                        <TableCell style={{
                                            border: 1,
                                            borderStyle: 'solid'
                                    ...
                                    <TableRow>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Взаимооценка</TableCell>
                                        <TableCell style={{
                                            border: 1,
                                            borderStyle: 'solid'
                                    ...
                                    <TableRow>
                                        <TableCell style={{border: 1, borderStyle: 'solid'}}>Самооценка</TableCell>
                                        <TableCell style={{
                                            border: 1,
                                            borderStyle: 'solid'
